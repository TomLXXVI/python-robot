...
class Axis(ABC):
    ...
    @abstractmethod
    def scale(self, lower_limit: float, upper_limit: float, step: float | None = None):
        pass
...
class X1Axis(Axis):
    ...
    def scale(self, lower_limit: float, upper_limit: float, step: float | None = None):
        if step is not None:
            ...
            self._axes.set_xlim(lower_limit, upper_limit)
...
class Y1Axis(Axis):
    ...
    def scale(self, lower_limit: float, upper_limit: float, step: float | None = None):
        if step is not None:
            ...
            self._axes.set_ylim(lower_limit, upper_limit)
...
class X2Axis(Axis):
    ...
    def scale(self, lower_limit: float, upper_limit: float, step: float | None = None):
        if step is not None:
            ...
            self._twin_axes.set_xlim(lower_limit, upper_limit)
    
    def format_ticks(self, fmt: str = '%.2f'):
        self._twin_axes.xaxis.set_major_formatter(FormatStrFormatter(fmt))

    def set_log_scale(self):
        self._twin_axes.set_xscale('log')
...
class Y2Axis(Axis):
    ...
    def scale(self, lower_limit: float, upper_limit: float, step: float | None = None):
        if step is not None:
            ...
            self._twin_axes.set_ylim(lower_limit, upper_limit)

    def format_ticks(self, fmt: str = '%.2f'):
        self._twin_axes.yaxis.set_major_formatter(FormatStrFormatter(fmt))

    def set_log_scale(self):
        self._twin_axes.set_yscale('log')
