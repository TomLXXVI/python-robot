"""
Single-line Cartesian motion between two target frames.
"""
...
@dataclass(frozen=True)
class TriPhaseTimeScalingParams(TimeScalingParams, ABC):
    """
...
@dataclass(frozen=True)
class Trapezoidal(TriPhaseTimeScalingParams):
    """
...
@dataclass(frozen=True)
class SCurved(TriPhaseTimeScalingParams):
    """
...
@dataclass(frozen=True)
class PolynomialTimeScalingParams(TimeScalingParams, ABC):
    """
...
@dataclass(frozen=True)
class Cubic(PolynomialTimeScalingParams):
    """
...
@dataclass(frozen=True)
class Quintic(PolynomialTimeScalingParams):
    """
...
class CartesianLineMotion:
    ...
    time_scaling: TimeScalingParams
    ...
    @staticmethod
    def _create_triphase_profile(params: TriPhaseTimeScalingParams) -> TriPhaseMotionProfile:
    ...
    @staticmethod
    def _create_poly_profile(params: PolynomialTimeScalingParams) -> PolyMotionProfile:
